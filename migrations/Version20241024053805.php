 ...
 */
final class Version20241024053805 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE details_document_commercial (id VARCHAR(255) NOT NULL, id_produit VARCHAR(255) NOT NULL, document_commercial VARCHAR(255) NOT NULL, quantite DOUBLE PRECISION NOT NULL, prix_unitaire NUMERIC(10, 2) NOT NULL, tva NUMERIC(4, 2) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_DE4D5037F7384557 ON details_document_commercial (id_produit)');
        $this->addSql('CREATE INDEX IDX_DE4D5037D79058F8 ON details_document_commercial (document_commercial)');
        ...
        $this->addSql('CREATE TABLE produit (id VARCHAR(255) NOT NULL, id_unite VARCHAR(255) DEFAULT NULL, designation VARCHAR(255) NOT NULL, prix_unitaire NUMERIC(10, 2) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE details_document_commercial ADD CONSTRAINT FK_DE4D5037F7384557 FOREIGN KEY (id_produit) REFERENCES produit (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE details_document_commercial DROP CONSTRAINT FK_DE4D5037F7384557');
        ...
        $this->addSql('DROP TABLE details_document_commercial');
